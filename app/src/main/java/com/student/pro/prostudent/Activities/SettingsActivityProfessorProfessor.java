...
public class SettingsActivityProfessorProfessor extends PreferenceActivityProfessor {
    ...
    public void onBuildHeaders(List<Header> target) {
        loadHeadersFromResource(R.xml.pref_headers_professor, target);
    }
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class TicketsPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_tickets_professor);
            setHasOptionsMenu(true);
        }
